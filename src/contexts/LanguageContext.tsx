...
const translations = {
  en: {
    ...
    emailProviderPlaceholder: "Select your email provider",
    ...
    expectedLaunch: "Expected launch: Q3 2025 • You'll be among the first to know",
    ...
    letSqulioWorkDesc: "Gain back 45 minutes daily with Squlio.AI",
  ...
  de: {
    ...
    emailProviderLabel: "E-Mail-Anbieter",
    emailProviderPlaceholder: "Wählen Sie Ihren E-Mail-Anbieter",
    ...
    expectedLaunch: "Erwarteter Launch: Q3 2025 • Sie werden zu den ersten gehören, die es erfahren",
    ...
    letSqulioWorkDesc: "Gewinnen Sie täglich 45 Minuten zurück mit Squlio.AI",
