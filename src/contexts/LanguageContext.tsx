...
const translations = {
  en: {
    ...
    letSqulioWorkDesc: "Gain back 1 hour and 15 minutes daily with Squlio.AI",
  ...
  de: {
    ...
    letSqulioWorkDesc: "Gewinnen Sie täglich 1 Stunde und 15 Minuten zurück mit Squlio.AI",
